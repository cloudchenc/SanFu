...
public class HomeGridView1 extends BaseAdapter {
    private Context context;
    private LayoutInflater layoutInflater;
    private ArrayList<String> list4;

    public HomeGridView1(Context context, ArrayList<String> list4) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.home_gridview1, null);
